...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jsConfig = __webpack_require__(11);

	var _jsConfig2 = _interopRequireDefault(_jsConfig);
	...
	var InputPassword = (function (_Component) {
	    ...
	    function InputPassword(props) {
	        ...
	        _get(Object.getPrototypeOf(InputPassword.prototype), 'constructor', this).call(this, props);
	        ...
	        this.unMaskStyle = {
	            color: _jsConfig2['default'].unMaskColor,
	            fontWeight: 200
	        };
	    ...
	    _createClass(InputPassword, [{
	        ...
	        value: function componentDidMount() {
	            var zxcvbnSrc = undefined;

	            // Load zxcvbn async if its enabled and doesn't already exist
	            if (this.props.zxcvbn && typeof zxcvbn === 'undefined') {

	                zxcvbnSrc = this.props.zxcvbn !== 'debug' ? this.props.zxcvbn : _jsConfig2['default'].zxcvbnSrc;

	                // snippet to async load zxcvbn if enabled
	                (function () {
	                    var a = undefined,
	                        b = undefined;b = document.createElement("script");b.src = zxcvbnSrc;b.type = "text/javascript";b.async = !0;a = document.getElementsByTagName("head")[0];a.parentNode.insertBefore(b, a);
	                }).call(this);
	            }

	            // set debouncer for password
	            if (this.props.toggleMask) {
	                this.maskPassword = (0, _lodashDebounce2['default'])(this.addPasswordType, this.props.unMaskTime);
	            }
	        }
	    }, {
	        ...
	        key: 'getMeterStyle',
	        value: function getMeterStyle(score) {
	        ...
	        key: 'addPasswordType',
	        value: function addPasswordType() {
	            this.setState({
	                isPassword: true
	            });
	        }
	        ...
	        key: 'handleToggleMask',
	        value: function handleToggleMask() {
	        ...
	        key: 'handleZxcvbn',
	        value: function handleZxcvbn(val) {
	        ...
	        key: 'handleMinLength',
	        value: function handleMinLength(len) {
	        ...
	        value: function render() {
	            ...
	            var passwordString = _props.passwordString;
	            var strengthLang = _props.strengthLang;
	            var infoBar = _props.infoBar;
	            var statusColor = _props.statusColor;
	            var statusInactiveColor = _props.statusInactiveColor;
	            var zxcvbn = _props.zxcvbn;
	            var minScore = _props.minScore;
	            var toggleMask = _props.toggleMask;
	            var unMaskTime = _props.unMaskTime;

	            var rest = _objectWithoutProperties(_props, ['onChange', 'passwordString', 'strengthLang', 'infoBar', 'statusColor', 'statusInactiveColor', 'zxcvbn', 'minScore', 'toggleMask', 'unMaskTime']);

	            if (infoBar) {
	                infoBarView = _react2['default'].createElement(
	                    'div',
	                    { className: 'passwordField__info', style: this.infoStyle },
	                    _react2['default'].createElement('span', { style: this.iconStyle, className: 'passwordField__icon' }),
	                    _react2['default'].createElement('span', { style: this.getMeterStyle(this.state.score), className: 'passwordField__meter' }),
	                    _react2['default'].createElement(
	                        'span',
	                        { style: this.strengthLangStyle, className: 'passwordField__strength' },
	                        zxcvbn && this.state.value.length > 0 && strengthLang.length > 0 ? strengthLang[this.state.score] : null
	                    )
	                );
	            }
	...
	InputPassword.propTypes = {
	    infoBar: _propTypes2['default'].bool,
	    statusColor: _propTypes2['default'].string,
	    statusInactiveColor: _propTypes2['default'].string,
	    minScore: _propTypes2['default'].number,
	    changeCb: _propTypes2['default'].func,
	    toggleMask: _propTypes2['default'].bool,
	    unMaskTime: _propTypes2['default'].number,
	    minLength: _propTypes2['default'].number,
	    strengthLang: _propTypes2['default'].array,
	    id: _propTypes2['default'].string,
	    passwordString: _propTypes2['default'].string
	};
	...
	InputPassword.defaultProps = {
	    infoBar: true,
	    statusColor: _jsConfig2['default'].statusColor,
	    statusInactiveColor: _jsConfig2['default'].statusInactiveColor,
	    zxcvbn: _jsConfig2['default'].zxcvbnSrc,
	    minScore: 0,
	    toggleMask: true,
	    unMaskTime: _jsConfig2['default'].unMaskTime,
	    strengthLang: _jsConfig2['default'].strengthLang,
	    id: 'input',
	    passwordString: ''
	};
